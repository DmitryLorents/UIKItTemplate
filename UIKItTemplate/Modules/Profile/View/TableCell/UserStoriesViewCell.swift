// UserStoriesViewCell.swift
// Copyright © RoadMap. All rights reserved.

import UIKit

/// Cell to show user stories
final class UserStoriesViewCell: UITableViewCell {
    // MARK: - Constants
    ...
    static let reuseID = String(describing: UserStoriesViewCell.self)
