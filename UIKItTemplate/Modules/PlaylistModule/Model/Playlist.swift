...
//  UIKItTemplate
//
//  Created by Dmitry on 11.02.2024.
//
...
struct Playlist {
    ...
    init() {
        ...
        let track1 = Track(image: "cover1", artist: "Год змеи", name: "Секс и рок-н-ролл", duration: "3:02", path: path1)
        let track2 = Track(image: "cover3.jpg", artist: "Король и Шут", name: "Лесник", duration: "3:12", path: path2)
        let track3 = Track(image: "cover2.jpg", artist: "Коктейл Шаляпина", name: "Метро", duration: "3:17", path: path3)
